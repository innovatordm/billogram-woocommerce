<?php
/**
 * Customer processing order email (Modified for Billogram Gateway)
 *
 * @author 		WooThemes
...
<p>
	<?php
	echo __( "Your order has now been received.", 'billogram-wc' ) . "<br>";
...
<p><?php _e( "Your order details are shown below for your reference:", 'billogram-wc' ); ?></p>
